...
import { idlFactory } from './clp.did.js';
export { idlFactory } from './clp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CLP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./clp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the clp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./clp.did.js")._SERVICE>}
 */
export const clp = createActor(canisterId);
